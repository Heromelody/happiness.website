...
<head>
  ...
  <title>happiness.Com-Men's</title>
  <meta charset="utf-8">
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" id="font" href="../index2.php" >happiness.com</a>
    </div>
 ...
 <div class="container-fluid" style="width:90%;">
  ...
  ?>
    <div class="product-item" style="background:#fff;">
      ...
      <div class="product-price"><?php echo $product_array[$key]["price"]. "Tsh"; ?></div>
      </form>
    </div>
  <?php
      }
